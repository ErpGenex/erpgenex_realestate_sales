...
"""Full RE Marketing workspace — SAP SD / Van Sales parity catalog."""
...
WORKSPACE_NAME = "RE Marketing"

_SHORTCUT_COLORS = ("Blue", "Green", "Orange", "Red", "Cyan", "Purple", "Teal", "Pink", "Yellow")

WORKSPACE_SECTIONS: list[tuple[str, list[WorkspaceLink]]] = [('📊 Dashboards', [('Page', 'rs-executive-dashboard', 'Executive Dashboard'), ('Page', 'rs-sales-portal', 'Sales Portal')]), ('🎯 CRM', [('DocType', 'Property Sales Lead', 'Sales Lead'), ('DocType', 'Unit Reservation', 'Unit Reservation'), ('DocType', 'Sales Booking', 'Sales Booking')]), ('💰 Commissions', [('DocType', 'Sales Commission Schedule', 'Commission Schedule'), ('DocType', 'Sales Payment Plan Item', 'Payment Plan Item')]), ('📈 Reports', [('Report', 'Campaign ROI', 'Campaign ROI'), ('Report', 'Sales Commission Accrual', 'Commission Accrual')])]

_REMOVED_SECTIONS = [
	(
		"📊 Dashboards & Mobile",
		[
			("Page", "rs-executive-dashboard", "Executive Dashboard"),
			("Page", "rs-van-sales-pwa", "Van Sales PWA"),
		],
	),
	(
		...
		[
			...
			("DocType", "RE Marketing Vehicle", "RE Marketing Vehicle"),
			("DocType", "RE Marketing Sales Representative", "Sales Representative"),
		],
	),
	(
		"🚚 Field Sales & Distribution",
		[
			("DocType", "RE Marketing Route Plan", "Route Plan"),
			("DocType", "RE Marketing Distribution Order", "Distribution Order"),
			("DocType", "RE Marketing Van Sales Invoice", "Van Sales Invoice"),
			("DocType", "RE Marketing Vehicle Stock Transfer", "Vehicle Stock Transfer"),
		],
	),
	(
		"💰 Commissions & Incentives",
		[
			("DocType", "RE Marketing Commission Rule", "Commission Rule"),
			("DocType", "RE Marketing Commission Settlement", "Commission Settlement"),
		],
	),
	(
		"📋 Tenders & Credit",
		[
			("DocType", "RE Marketing Tender", "Tender"),
			("DocType", "RE Marketing Installment Contract", "Installment Contract"),
		],
	),
	(
		"💳 Finance & ERP",
	...
	(
		...
		[
			("Report", "RE Marketing Sales Summary", "Sales Summary"),
			("Report", "RE Marketing Distribution Fulfillment", "Distribution Fulfillment"),
			("Report", "RE Marketing Vehicle Transfer Summary", "Vehicle Transfer Summary"),
			("Report", "RE Marketing Route Efficiency", "Route Efficiency"),
			("Report", "RE Marketing Rep Target Tracking", "Rep Target Tracking"),
		],
	),
	(
		"📈 Reports · Commissions & Pipeline",
		[
			("Report", "RE Marketing Commission Summary", "Commission Summary"),
			("Report", "RE Marketing Tender Pipeline", "Tender Pipeline"),
			("Report", "RE Marketing Installment Portfolio", "Installment Portfolio"),
		],
	),
	(
		"📈 Reports · Finance & POS",
...
def _build_link_rows() -> list[dict]:
	return build_link_rows_for_app("erpgenex_realestate_sales", WORKSPACE_SECTIONS)
...
def _build_content(link_rows: list[dict], ws) -> str:
	...
	content.append(
		{
			"id": "rs-title",
			"type": "header",
			"data": {"text": '<span class="h4"><b>RE Marketing</b></span>', "col": 12},
		}
	)
	section_idx = 0
	link_idx = 0
	for row in link_rows:
		if row.get("type") == "Card Break":
			if section_idx:
				content.append({"id": f"rs-sp-{section_idx}", "type": "spacer", "data": {"col": 12}})
			content.append(
				{
					"id": f"rs-sec-{section_idx}",
					"type": "header",
	...
	if ws.number_cards:
		content.append({"id": "rs-kpi-sp", "type": "spacer", "data": {"col": 12}})
		content.append(
			{
				"id": "rs-kpi-h",
				"type": "header",
	...
	if ws.charts:
		content.append({"id": "rs-ch-sp", "type": "spacer", "data": {"col": 12}})
		content.append(
			{
				"id": "rs-ch-h",
				"type": "header",
...
def sync_rs_workspace_menu(*, save: bool = True, rebuild: bool = True) -> dict:
